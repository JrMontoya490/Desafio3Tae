    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void JumpAndGravity()
        {
            ...
            else
            {
                ...
                // si no estamos en el suelo, no saltar
                _input.jump = false;
            }

            // aplicar gravedad con el tiempo si está por debajo del terminal (multiplicar por delta time dos veces para acelerar linealmente con el tiempo)
